...
OPTS+="--list_val /data/pojha/research/source_code/sound-of-pixels/data/val.csv "
OPTS+="--list_train /data/pojha/research/source_code/sound-of-pixels/data/train.csv "
